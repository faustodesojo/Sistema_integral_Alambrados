...
import { Plus, Search, FileText, ArrowRight, Printer } from 'lucide-react';
...
const SalesOrders = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 p-6">
      <Helmet><title>Órdenes de Venta - Sistema</title></Helmet>
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`px-2 py-0.5 rounded-full text-xs ${
                            order.status === 'Entregada' ? 'bg-green-500/20 text-green-400' :
                      ...
                      <div className="text-right">
                        <p className="text-xl font-bold text-white">${(order.total || 0).toLocaleString()}</p>
              ...
              {filteredQuotes.map(quote => (
                <div key={quote.id} className="bg-slate-800 border border-slate-700 rounded-xl p-5 hover:border-orange-500 transition-all">
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-slate-700">
                    <span className="text-lg font-bold text-white">${(quote.total || 0).toLocaleString()}</span>
