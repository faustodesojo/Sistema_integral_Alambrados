...
const QuoteHistory = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-900 p-6">
            <Helmet>
                <title>Historial de Presupuestos - Alambrados Belgrano</title>
            </Helmet>
                    ...
                    {filteredQuotes.length > 0 ? (
                        ...
                        <div className="text-center py-16 border-2 border-dashed border-slate-700/50 rounded-xl bg-slate-800/20">
                            ...
                            <p className="text-slate-400 max-w-md mx-auto mb-6">
                                {searchTerm
                                    ? `No encontramos ningún presupuesto que coincida con "${searchTerm}".`
                                    : 'Comienza generando un nuevo presupuesto desde el cotizador.'
                                }
                            </p>
                            {searchTerm && (
